...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        dLoss_dout2 = (p - y_id) / N  # [NxC]
        grads['W2'] = gate_1.T.dot(dLoss_dout2) + reg * W2
        grads['b2'] = np.sum(dLoss_dout2, axis=0)
        ...
        dLoss_db1 = np.sum(dLoss_dOut1, axis=0)
    ...
    def predict(self, X):
        ...
        ###########################################################################
        gate_1 = np.maximum(0, X.dot(self.params['W1']) + self.params['b1'])
        scores = gate_1.dot(self.params['W2']) + self.params['b2']
